...
const supportedChainId = [ChainId.GOERLI, ChainId.BSC, ChainId.BSC_TESTNET, ChainId.ETHEREUM, ChainId.ONUS_TESTNET, ChainId.ONUS]
...
export function createFarmFetcher(multicallv2: MultiCallV2) {
  ...
  return {
    ...
    supportedChainId,
    isTestnet: (chainId: number) => ![ChainId.BSC, ChainId.ETHEREUM, ChainId.ONUS_TESTNET, ChainId.ONUS].includes(chainId),
  }
}

...
const RoiCalculatorModal: React.FC<React.PropsWithChildren<RoiCalculatorModalProps>> = ({
  ...
  const editingUnit = editingCurrency === EditingCurrency.TOKEN ? stakingTokenSymbol : renderCurenccySymbol()
  const editingValue = editingCurrency === EditingCurrency.TOKEN ? principalAsToken : principalAsUSD
  const conversionUnit = editingCurrency === EditingCurrency.TOKEN ? renderCurenccySymbol() : stakingTokenSymbol
    ...
    >
      <ScrollableContainer>
        ...
        <Flex flexDirection="column" mb="8px">
          <Text color="silver" bold fontSize="12px" textTransform="uppercase">
          ...
          <Flex justifyContent="space-between" mt="8px">
            ...
            <span ref={targetRef}>
              {/* <HelpIconFarms width="22px" height="22px" color="textSubtle" /> */}
              <HelpIcon color="#A95EEA"/>
            </span>
            {tooltipVisible && tooltip}
          </Flex>
          {children || (
            <>
              <Text mt="24px" color="silver" bold fontSize="12px" textTransform="uppercase">
                {t('Staked for')}
              </Text>

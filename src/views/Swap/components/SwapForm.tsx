...
`
const CsSwapCommitButton = styled(SwapCommitButton)`
   display:flex;
  ...
  return (
    <>
      <>
        ...
        /> */}
        {/* <Wrapper id="swap-page" style={{ minHeight: '412px',width:'100%' }}> */}
          ...
          <AutoColumn gap="sm">
            ...
            <AutoColumn justify="space-between" style={{paddingTop:'1rem',paddingBottom:'1rem'}}>
            ...
            {showWrap ? null : (
              <AutoColumn gap="7px" style={{ padding: '16px' }}>
                <RowBetween align="center">
                  {Boolean(trade) && (
                    <>
                      <Label mr="8px">{t('Price')}</Label>
                      {isLoading ? (

  ...
  return (
    <Container expanded={expanded}>
      <InfoContainer>
        ...
        {isActive && (
          <StakeContainer>
            <StyledLinkExternal color='secondary100' href={`/add/${liquidityUrlPathParts}`}>
              {t('Get %symbol%', { symbol: lpLabel })}
            </StyledLinkExternal>
          </StakeContainer>
        )}
        <StyledLinkExternal color='secondary100' href={bsc}>{t('View Contract')}</StyledLinkExternal>

...
import { AddIcon, Button, IconButtonV2, MinusIcon, Skeleton, Text, useModal, useToast } from '@pancakeswap/uikit'
...
import { useLpTokenPrice, usePriceRunBusd } from 'state/farms/hooks'
...
export const StakedContainer = ({ children, ...props }) => {
  ...
  const { lpAddress, liquidity } = props
...
const Staked: React.FunctionComponent<React.PropsWithChildren<StackedActionProps>> = ({
  ...
  const convertLiquidity = Number(liquidity?.toString()) > 0
  ...
  if (isApproved) {
    if (stakedBalance.gt(0)) {
      return (
        <StyledActionContainer>
          <ActionTitles>
            <Text bold textTransform="uppercase" color="primaryBright" fontSize="12px" pr="4px">
              {lpSymbol}
            </Text>
            <Text bold textTransform="uppercase" color="textSubtle" fontSize="12px">
              {t('Staked')}
          ...
          <ActionContent>
            ...
            />
            <IconButtonWrapper>
              <IconButtonV2 variant="secondary" onClick={onPresentWithdraw} mr="6px">
    ...
    return (
      <StyledActionContainer>
        <ActionTitles>
          ...
          <Text bold textTransform="uppercase" color="primaryBright" fontSize="12px">
            {lpSymbol}
          </Text>
        </ActionTitles>
        <ActionContent>

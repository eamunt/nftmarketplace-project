...
import { AddIcon, Button, Flex, IconButtonV2, MinusIcon, useModal, useToast } from '@pancakeswap/uikit'
...
const StakeAction: React.FC<React.PropsWithChildren<FarmCardActionsProps>> = ({
  ...
  const renderStakingButtons = () => {
    return stakedBalance.eq(0) ? (
      ...
      <IconButtonWrapper>
        <IconButtonV2 variant="tertiary" onClick={onPresentWithdraw} mr="6px">

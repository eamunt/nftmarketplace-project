...
export default function RemoveLiquidity({ currencyA, currencyB, currencyIdA, currencyIdB }) {
          ...
          setLiquidityState({
            ...
            liquidityErrorMessage:
              err && err?.code !== 4001
                ...
                ? t('Remove liquidity failed: An unspecified error occurred. Please try again',)
  ...
  return (
    ...
    <Container>
      <WrapAppBody>
     <Wrapper id="remove-liquidity-page">
        <AppHeader
          backTo="/liquidity"
        ...
        <CardBody>
          ...
          <RowBetween>
                      ...
                      <Text color="#ff592c" fontWeight="600">{showDetailed ? t('Simple') : t('Detailed')}</Text>
                      </Button>
                </RowBetween>  
            {!showDetailed && (
              <BorderCard>           
                ...
                {/* <Slider
                  ...
                  mb="16px"
                /> */}
                 <CustomProgress bgcolor='#ff592c' variant="round" primaryStep={innerLiquidityPercentage} />
          ...
          {!showDetailed && (
            <>
              ...
              <AutoColumn gap="10px">
                <Text bold color="text" fontSize="12px" textTransform="uppercase" pt="10px">
                  {t('Receive')}
                </Text>
                <LightGreyCard>

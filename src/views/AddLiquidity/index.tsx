...
import { CsLightCard } from '../../components/Card'
        ...
        setLiquidityState({
          ...
          liquidityErrorMessage:
            err && err.code !== 4001
              ...
              ? t('Add liquidity failed: An unspecified error occurred. Please try again')
              : undefined,
          txHash: undefined,
        })
      })
     ...
     <Wrapper id="addliquidity-page">
            ...
            <CardBody>
              <AutoColumn gap="20px">
                ...
                {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
                  <>
                    <CsLightCard padding="0px" borderRadius="20px">
                      <RowBetween padding="1rem">
                        <Text fontSize="14px">
                          {noLiquidity ? t('Initial prices and pool share') : t('Prices and pool share')}
                        </Text>
                      </RowBetween>{' '}
                      <Flex padding="1rem" width="100%" flexDirection="column">
                        <PoolPriceBar
                          currencies={currencies}
                ...
                {addIsUnsupported || addIsWarning ? (
                  ...
                  <AutoColumn gap="md">
                    ...
                    <CommitButton
                      ...
                      variant={!isValid || zapIn.priceSeverity >  2 ? 'light' : 'primary'}
                      ...
                      disabled={buttonDisabled || preferZapInstead && zapInEstimating}
                    >
                      {errorText || t('Supply')}
                    </CommitButton>
                  </AutoColumn>
      ...
      {!(addIsUnsupported || addIsWarning) ? (
        pair && !noLiquidity && pairState !== PairState.INVALID ? (
          <AutoColumn style={{ minWidth: '20rem', width: '100%', marginTop: '1rem',padding:'24px' }}>
...
const ContainerCurrency = styled(Flex)`

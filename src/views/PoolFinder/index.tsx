...
import { AddIcon, Button, ChevronDownIcon, Text, useModal,Flex } from '@pancakeswap/uikit'
  ...
  return (
    ...
    <Container>
     ...
     <Wrapper id="find-page">
        ...
        <AutoColumn style={{ padding: '2rem' }} gap="md">
          <StyledButton
              ...
              hasPosition && pair ? (
                ...
                <LightCard padding="45px 10px">
                  <AutoColumn gap="sm" justify="center">
                    <Text pb="10px" textAlign="center">{t('You don’t have liquidity in this pool yet.')}</Text>
                    <Button

...
// add buy NFT
export function useCoreBuyNFT(marketplaceAddress?: string, withSignerIfPossible?: boolean): Contract | null {
    return useContract(marketplaceAddress, coreBuyNFTAbi, withSignerIfPossible);
}
